                    ...
                    <div className={stylesPop.body__container}>
                        <div className={styles.modal}>
                            <div className={styles.modal__content}>
                                <Link className={styles.btn__exit} href="http://localhost:3000/donate">
                                ...
                                <Link className={styles.btn} href="http://localhost:3000">
                                {t('btn')}
                                </Link>
                            </div>
                        </div>
                ...
                <div className={styles.modal__no}>
                    <div className={styles.modal__content}>
                        ...
                        <div className={styles.img}></div>
                            ...
                            <Link className={styles.btn} href="http://localhost:3000/donate">
                            {t('btn1')}
                            </Link>
                        </div>
                        </div>
