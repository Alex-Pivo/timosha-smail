...
export default function Reports({locale}:any) {
  ...
  const renderCustomizedLabel = ({
    ...
    const returnNumber = () => {
      ...
      if((percent * 100) === 100) {return (percent * 100).toFixed(0) + "%";}
      else if((percent * 100) === 0){return "" }
      else {return (percent * 100).toFixed(1) + "%";}
    }
      ...
      <div className={styles.reports}>
        <div className={styles.reports__fond}>
          <p className={styles.pages}>
            ...
            /<Link href="/reports" className={styles.historyLink}> {t('mTitle')}</Link>
          </p>
          ...
          className={styles.btn__container1}
                  ...
                  {state.map((stat, i) => (
                    <button
                    key={stat.id}
                    className={selectedItem === i ? styles.btn__active : styles.btn__}
                    onClick={()=>{
                      handleClick(i)
                      getIndex(i)
                    }}
          ...
          <div className={styles.container}>
            ...
            <div className={styles.info}>
              <div className={styles.track}>
                  ...
                  <div id="scrollableBlock" className={styles.btn__container}
                   ref={scrollableRef}
                  >
                  {state.map((stat, i) => (
                    <button
              ...
              <div className={styles.info__container}>
                ...
                {state.length > 0 && (
                       state[index] && state[index].second_description !== "" && (
                 ...
                 {state.length > 0 && (
                        state[index] && state[index].third_description !== "" && (
                          <div className={styles.sektor}>
                            <div className={styles.number}
                             style={{
                ...
                {state.length > 0 && (
                        state[index] && state[index].fourth_description !== "" && (
                          <div className={styles.sektor}>
                            <div className={styles.number}
                             style={{
              ...
              <div className={styles.text__container}></div>
                {state.length > 0 && state[index] && state[index].statement_file && (
                                  <button onClick={handleClickDonwload} className={styles.btn}>
                                    ...
                                    {state.length > 0 && state[index] && state[index].statement_file_name && (
